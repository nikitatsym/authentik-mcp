...
def list_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/all/", limit=limit)
...
def list_scope_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/scope/", limit=limit)
...
def list_saml_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/saml/", limit=limit)
...
def list_scim_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/scim/", limit=limit)
...
def list_radius_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/radius/", limit=limit)
...
def list_rac_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/rac/", limit=limit)
...
def list_google_workspace_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/google_workspace/", limit=limit)
...
def list_microsoft_entra_property_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/provider/microsoft_entra/", limit=limit)
...
def list_notification_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/notification/", limit=limit)
...
def list_ldap_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/ldap/", limit=limit)
...
def list_oauth_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/oauth/", limit=limit)
...
def list_saml_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/saml/", limit=limit)
...
def list_scim_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/scim/", limit=limit)
...
def list_kerberos_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/kerberos/", limit=limit)
...
def list_plex_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/plex/", limit=limit)
...
def list_telegram_source_mappings(limit: int = 20):
    ...
    return _paginated("/propertymappings/source/telegram/", limit=limit)
