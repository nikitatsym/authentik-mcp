...
def list_oauth2_access_tokens(limit: int = 20):
    ...
    return _paginated("/oauth2/access_tokens/", limit=limit)
...
def list_oauth2_authorization_codes(limit: int = 20):
    ...
    return _paginated("/oauth2/authorization_codes/", limit=limit)
...
def list_oauth2_refresh_tokens(limit: int = 20):
    ...
    return _paginated("/oauth2/refresh_tokens/", limit=limit)
